INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('001', '2019-01-21', 'John', 'Smith', 'Tim', 'Mr', 123456789);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('002', '2019-01-20', 'Joey', 'Johnson', 'Dax', 'Mr', 123456788);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('003', '2019-01-19', 'Sam', 'Williams', 'Jake', 'Mr', 123456787);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('004', '2019-01-18', 'Ryann', 'Jones', 'Tyson', 'Mr', 123456786);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('005', '2019-01-17', 'Ty', 'Brown', 'Russell', 'Mr', 123456785);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('006', '2019-01-16', 'Kate', 'Davis', 'Ann', 'Ms', 123456784);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('007', '2019-01-15', 'Howard', 'Miller', 'Olive', 'Mr', 123456783);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('008', '2019-01-14', 'Robert', 'Hall', 'Justin', 'Mr', 123456782);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('009', '2019-01-13', 'Susan', 'Allen', 'Racheal', 'Ms', 123456781);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('010', '2019-01-12', 'Tori', 'Young', 'Vanessa', 'Ms', 123456780);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('011', '2019-01-11', 'Hillary', 'Cook', 'Aliyah', 'Ms', 123456779);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('012', '2019-01-10', 'Mia', 'King', 'Shayna', 'Ms', 123456778);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('013', '2019-01-09', 'Joslyn', 'Stewart', 'Miranda', 'Ms', 123456777);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('014', '2019-01-08', 'Joel', 'Wood', 'Mike', 'Mr', 123456776);
INSERT INTO bank.person (person_id, start_date, name_first, name_last, name_middle, titlle, social_security_number) VALUES ('015', '2019-01-07', 'Donald', 'Ross', 'Logan', 'Mr', 123456775);
